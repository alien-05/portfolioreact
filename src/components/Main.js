            ...
            <div className="container mt-0 mt-lg-3 hero d-flex flex-wrap align-items-center">
                <div className="row mt-0 mt-lg-5">
                    <div className="col-12 col-lg-6">
                        ...
                        <span className="fonction d-flex justify-content-center justify-content-lg-start text-muted fs-3 mt-0 mb-1">I'm a web developer </span>
                        <p className="description  lh-base font-monospace pt-3 pb-0 pb-lg-1 text-capitalize">
